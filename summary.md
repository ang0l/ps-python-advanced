...
Возможность работать с объектами через общий интерфейс, не зная их внутренних структур. Пример: использование разных операционных систем на ноутбуках через единый интерфейс.
