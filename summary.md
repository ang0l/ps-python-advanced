...
В этой лекции рассматриваются функции `getattr()`, `setattr()` и `hasattr()`, которые позволяют управлять атрибутами объектов в Python.
...
Примеры использования:
   ...
   - динамическое выполнение команд, как в случае с ботом, где команды `start`, `stop`, `help` могут быть вызваны на основе пользовательского ввода.
