...
Так как статические методы не имеют доступ к объекту, они служат для задач, которым не нужно состояние объектов, но которые логически связаны с функциональностью класса.